...
P.append('<div class="slide">'
         ...
         '<td>&#9745; <b style="color:#0d9488">Microcontroller</b> <span class="k">(Raspberry Pi Pico + '
         '<a href="https://ca.robotshop.com/products/raspberry-pi-pico-headers-kit">headers kit</a>; ordered #1482457 &mdash; Pico backordered ~Jun&nbsp;25)</span></td><td>1</td>'
         ...
         '<td>&#9744; <b style="color:#2563eb">Static-latch shift register</b> <span class="k">(SN74HC595N &mdash; 1 of 4 ordered #1482457; 3 more needed)</span></td><td>4</td>'
         '<td><a href="https://www.digikey.ca/en/products/detail/texas-instruments/SN74HC595N/277246">DigiKey.ca</a> (RobotShop sold out)</td><td>$10</td></tr>'
         '<tr><td class="th"></td>'
         ...
         '<tr class="tot"><td></td><td>Total</td><td></td><td></td><td>~$115 (+$25)</td></tr>'
         '</table>'
         ...
         '<b>Ordered (RobotShop #1482457, 2026-06-17, $36.16):</b> Pico + headers, rigid jumper kit, and 1 of 4 shift registers '
         '(Pico backordered ~Jun&nbsp;25). <b>Still needed:</b> 3 more SN74HC595 (DigiKey) and a panel board. '
