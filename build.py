...
P.append('<div class="slide">'
         ...
         '<a href="https://www.robotshop.com/products/raspberry-pi-pico-headers-kit">headers kit</a>; Teensy 4.0 = overkill alt)</span></td><td>1</td>'
         ...
         '<tr><td class="th"></td><td>&#9744; <b>Rigid jumper kit</b> <span class="k">(Elenco JW-140 &mdash; tidies on-board wiring; optional)</span></td><td>1</td><td><a href="https://www.robotshop.com/products/elenco-jw-140-jumper-wire-kit">RobotShop.ca</a></td><td>$10</td></tr>'
         '<tr><td class="th"></td>'
         ...
         '<b>Still needed:</b> the microcontroller (+ headers) and 4&times; shift registers (the driver, highlighted), plus a panel board &mdash; all available at RobotShop. '
